...
from models.TransformerEncoder1 import TransformerEncoder
...
if __name__ == "__main__":
    ...
    # running parameters
    model_name = "transformer_encoder_mlp_decoder1"
    ...
    encoder = TransformerEncoder(input_dim=train_dataset.tensors[0].shape[-1],
                                 hidden_dim=256,
                                 num_edges=2,
                                 n_encoder_layers=4,
                                 n_decoder_layers=4,
